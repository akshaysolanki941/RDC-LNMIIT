...
import com.example.rdc_lnmiit.Models.CategoryModel;
...
public class AddDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("Add Data");
        ...
        databaseReference1 = FirebaseDatabase.getInstance().getReference("SchemeDataModel");
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    if (radioGroup.getCheckedRadioButtonId() != -1 && rg_inOperation.getCheckedRadioButtonId() != -1 && !TextUtils.isEmpty(gov_scheme_editText.getText()) && !TextUtils.isEmpty(year_editText.getText()) && !TextUtils.isEmpty(motive_editText.getText()) && !TextUtils.isEmpty(bene_editText.getText())) {
                        ...
                        if(selectedPhotoUri != null) {
                            ...
                            Animation shake = AnimationUtils.loadAnimation(AddDataActivity.this, R.anim.shake);
    ...
    private void addData(String picURL) {
        ...
        SchemeDataModel schemeDataModel = new SchemeDataModel(/*id, */scheme, year, motive, bene, mile, rg_value, picURL, rg_inOperation_value);

        //databaseReference1.child(category).push().setValue(categoryModel);
        databaseReference1.child(category).child(scheme).setValue(schemeDataModel);
